(() => {
  ...
  if (document.getElementById(stylesId)) {
    ...
    if (window[handlerName])
      window.removeEventListener("click", window[handlerName]);
  } else {
    ...
    if (window[handlerName])
      window.addEventListener("click", window[handlerName]);
  }
})();
